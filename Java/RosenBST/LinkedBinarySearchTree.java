                                        ...
                                        implements BinarySearchTreeADT<T>
{
   ...
   /* @Override
    ...
    // TODO: Implement find.
    public BinaryTreeNode<T> find( Comparable<T> target, BinaryTreeNode<T> root )
    {
        while( root != null )
    ...
    public boolean contain(Comparable<T> target) {
    	boolean result = false;
    	
    	BinaryTreeNode<T> temp = find(target, root);
